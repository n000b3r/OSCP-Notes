...
* Enumerate which logins allow impersonation ![](<../.gitbook/assets/image (1).png>)
  *   ```csharp
...
* Impersonate using EXECUTE AS USER
  * Impersonates a database user within a single database. ![](<../.gitbook/assets/image (4).png>)
  * ```csharp
...
- Finding linked servers on SQL server ![](<../.gitbook/assets/image (5).png>)
...
- Check if DC01 also links back to APPSrv01 ![](<../.gitbook/assets/image (6).png>)
  *   ```csharp
